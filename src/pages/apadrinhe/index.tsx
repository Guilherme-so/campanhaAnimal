...
import { SEO } from "../../SEO";
import style from "../style/apadrinhe.module.scss";
      ...
      {isOpen && (
        <div className={`${style.modal} ${isOpen && style.active}`}>
          <div className={style.modalContent}>
            ...
            <div className={style.containerApadrinheModal}>
              <div className={style.apadrinheCardModal}>
                <img src="/assets/images/conheca.png" alt="conheça" />
                <h2>CONHEÇA</h2>
                <p className={style.modalP}>
                  Conheça nossos animais se emociona <br />
                  com cada história deles.
                </p>
              </div>

              <div className={style.apadrinheCardModal}>
                <img src="/assets/images/Apadrinhe.png" alt="conheça" />
                <h2>Apadrinhe</h2>
                <p className={style.modalP}>
                  Após entender os custos do animal,
                  <br />
                  escolha qual você se identificou para apadrinhar.
                </p>
              </div>

              <div className={style.apadrinheCardModal}>
                <img src="/assets/images/Acompanhe.png" alt="conheça" />
                <h2>Acompanhe</h2>
                <p className={style.modalP}>
                  Como padrinho, você receberá materiais exclusivos sobre o
                  animal apadrinhado.
                </p>
              </div>
            </div>
      ...
      <div className={style.container}>
        <div className={style.containerBg}>
          ...
          <div className={style.wrapper}>
            <div className={style.apadrinheInfo}>
              <h1>Eu apadrinho!</h1>
              <p>
                Precisamos de toda ajuda possível nesta corrente de amor e
                solidariedade. Seja madrinha ou padrinho de um de nossos peludos
                que não conseguem achar um novo lar. <br />
                <br />
                Você escolhe o pet que deseja ajudar e se compromete a doar
                mensalmente. Todo o valor é revertido na compra de medicamentos,
                vacinas, atendimento veterinário e alimentação. Sua ajuda salva
                vidas!
              </p>
            ...
            <div className={style.imageHeroContainer}>
              <img
                ...
                src="/assets/images/pexels-владимир-васильев-10412407-removebg 1.png"
                alt="image hero"
              />
            </div>
          </div>
        ...
        <div className={style.mainContant}>
          <div className={style.sidebar}>
            <section className={style.sidebarMainContent}>
          ...
          <section className={style.mobileSearchContainer}>
            ...
            <input
              className={style.filtrarSearch}
              type="text"
              placeholder="Buscar"
            />
          </section>
            <h1>Conheça todos os animais</h1>
